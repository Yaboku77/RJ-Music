...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "Battery_Optimisation_message": MessageLookupByLibrary.simpleMessage(
      "RJ Music کو درست طریقے سے کام کرنے کے لئے بیٹری کی اصلاح کو غیر فعال کرنے کے لئے یہاں کلک کریں",
    ),
    ...
    "Donate_Message": MessageLookupByLibrary.simpleMessage(
      "RJ Music کی ترقی کی حمایت کریں",
    ),
    ...
    "Search_RJMusic": MessageLookupByLibrary.simpleMessage("RJ Music تلاش کریں"),
