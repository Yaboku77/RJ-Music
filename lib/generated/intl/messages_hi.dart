...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "Battery_Optimisation_message": MessageLookupByLibrary.simpleMessage(
      "RJ Music को ठीक से काम करने के लिए बैटरी ऑप्टिमाइजेशन को अक्षम करने के लिए यहां क्लिक करें",
    ),
    ...
    "Donate_Message": MessageLookupByLibrary.simpleMessage(
      "RJ Music के विकास का समर्थन करें",
    ),
    ...
    "Search_RJMusic": MessageLookupByLibrary.simpleMessage("RJ Music खोजें"),
