                ...
                ExpressiveListGroup(
                  ...
                  children: [
                    ExpressiveListTile(
                      ...
                      onTap: () => _open('https://github.com/Yaboku77'),
                    ),
                    ExpressiveListTile(
                      leading: const SettingsColorIcon(icon: Icons.link),
                      title: const Text("Website"),
                      trailing: const Icon(FluentIcons.chevron_right_24_filled),
                      onTap: () => _open('https://rj_musicmusic.vercel.app'),
                    ),
                  ],
                ),
                ...
                ExpressiveListGroup(
                  ...
                  children: [
                    ExpressiveListTile(
                      ...
                      trailing: const Icon(FluentIcons.chevron_right_24_filled),
                      onTap: () => _open(
                        'https://github.com/jhelumcorp/rj_music/contributors',
                      ),
                    ),
                    ExpressiveListTile(
                ...
                ExpressiveListGroup(
                  ...
                  children: [
                    ExpressiveListTile(
                      ...
                      trailing: const Icon(FluentIcons.chevron_right_24_filled),
                      onTap: () =>
                          _open('https://github.com/jhelumcorp/rj_music'),
                    ),
                    ExpressiveListTile(
                      ...
                      trailing: const Icon(FluentIcons.chevron_right_24_filled),
                      onTap: () => _open(
                        'https://github.com/Yaboku77/rj_music/issues/new?template=bug_report.yml',
                      ),
                    ),
                    ExpressiveListTile(
                      ...
                      trailing: const Icon(FluentIcons.chevron_right_24_filled),
                      onTap: () => _open(
                        'https://github.com/Yaboku77/rj_music/discussions',
                      ),
                    ),
                  ],
                ),
