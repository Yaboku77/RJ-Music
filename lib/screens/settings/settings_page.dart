...
import 'package:rj_music/services/update_service/update_service.dart';
    ...
    children: [
      AdaptiveListTile(
        ...
        onTap: () async {
          ...
          await Clipboard.setData(
            const ClipboardData(text: 'Yaboku7776@okaxis'),
          );
          if (context.mounted) {
      ...
      AdaptiveListTile(
        ...
        onTap: () async {
          Navigator.pop(context);
          await launchUrl(
            Uri.parse('https://ko-fi.com/Yaboku77'),
      ...
      AdaptiveListTile(
        ...
        onTap: () async {
          Navigator.pop(context);
          await launchUrl(
            Uri.parse('https://buymeacoffee.com/Yaboku77'),
            mode: LaunchMode.externalApplication,
          );
        },
      ),
